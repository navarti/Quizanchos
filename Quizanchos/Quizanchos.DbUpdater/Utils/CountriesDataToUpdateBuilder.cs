...
internal class CountriesDataToUpdateBuilder
{
    ...
    private DataToUpdate BuildCountriesDataToUpdateWithArea(List<Country> countries)
    {
        ...
        return new DataToUpdate(FeatureType.Float, "Country-Area", "https://cdn.britannica.com/96/212396-050-8B527272/world-map-with-country-borders.jpg", entities);
    }
    ...
    private DataToUpdate BuildCountriesDataToUpdateWithPopulation(List<Country> countries)
    {
        ...
        return new DataToUpdate(FeatureType.Int, "Country-Population", "https://www.healthstaffrecruitment.com.au/wp-content/uploads/2018/07/bigstock-World-population-rise-and-Eart-13736474.jpg", entities);
    }
}
